...
const ALLOW = [
// 程式碼本身（不是給人看的內容）：property.html 的規格表在拆「／」時，
// 要排除「円／月」「㎡／戸」這種單位斜線，正規表示式裡不得不寫日文單位字。
// 2026-09-18 加，避免每週六的 B8 一直誤報。
"(?!月|年|人|台|戸|坪|㎡|m2|m²|日|回|世帯)","「円／月」「㎡／戸」這種單位用的斜線不能拆",
"「円／月」「㎡／戸」這種單位用的斜線不能拆，只拆真正的並列項目",
// 法定登記資訊
"株式会社アンドプラス","住宅営業部","東京都渋谷区鶯谷町","ＳＵビル","シュウ シンユウ","宅地建物取引業者免許番号",
"宅地建物取引士","東京都知事","第102938号",
// 法規／官方頁面／資料來源正式名稱
"弁天町",   /* 大阪の地名（物件専区は地名の日本漢字を残す） */
"児童・生徒数","児童・生徒・園児數","児童・生徒・園児数","小學校通學區域",
"宅地建物取引業者検索","事務所一覧","犯罪収益移転防止法","犯収法","賃貸住宅の管理業務等の適正化に関する法律",
"乗りものニュース","賃貸住宅管理業法","マンションの修繕積立金に関するガイドライン","マンション総合調査","収益物件 市場動向",
...
"大島てる",   // 事故物件地圖網站的正式名稱（a53）。翻成中文讀者就搜不到了，同 Google Maps 查詢字的道理
