...
const JA_UI = {
  ...
  nav: { home: "ホーム", properties: "🏠 物件情報", services: "サービス内容", process: "購入の流れ", live: "マイホーム購入", invest: "投資・収益物件", translate: "不動産資料翻訳", videos: "動画", faq: "よくあるご質問", about: "会社概要", feedback: "ご意見・ご要望" },
