...
const REVIEWS_JA = [
  { text: "この度は、周周さんに大変お世話になりました。専門的なアドバイスと積極的なお取りまとめのおかげで、日本での住宅購入がこんなにもスムーズに、円満に成約できました。特に成約後も変わらずきめ細やかに、根気強く各種の手続きをサポートしてくださり、とても安心できました。改めて、ご尽力に心より感謝いたします！安心して取引できるので、他の台湾の友人にもぜひおすすめしたいです😊", who: "台湾の W 様", reply: "こちらこそ、ありがとうございます🥰 大切な人生の節目を信頼してお任せいただき、本当に感謝しています。内見から契約、お引渡し、その後の大小さまざまなことまで、ご一緒できたことが私の誇りです。このお家が、これからずっと幸せと素敵な思い出をもたらしてくれますように！何かあればいつでも周周にご連絡くださいね、ずっとここにいますよ😊✨❤️" },
  { text: "物件のご提案からオンライン内見・オンライン立会いまで、周さんに親身に対応いただきました。現地に行けない私たちのために家の細部まで丁寧に確認してくださり、引渡し後も全く違いがありませんでした。日本語が堪能で意思疎通もスムーズ、終始丁寧で誠実。引渡し後も煩雑な手続きを数多く手伝ってくださいました。本当に得難い方で、心から感謝しています。", who: "オンラインで内見・購入されたお客様", reply: "心のこもったお言葉、本当にありがとうございます🥹❤️ 現地にいらっしゃれない分、一回一回の内見・確認で代わりにもう一つでも多く確かめ、安心してお受け取りいただけたら——その一心でした😆 大切な節目をお任せいただき感謝しています🫶🏻 新しいお住まいでの幸せな毎日をお祈りしています🏡✨" },
  { text: "周周のおかげで日本で初めてのマイホームを購入できました。最初から最後まで中国語で対応いただき、とても丁寧で助かりました。今後また不動産の売買があれば必ずお願いしたいです。", who: "台湾 T様（初めての購入）", reply: "ご信頼いただきありがとうございます🥹 日本での初めてのマイホーム、私もとても嬉しいです！購入・売却はもちろん、生活のことでも何かあればいつでもご連絡ください☺️" },
  { text: "私たちはアメリカ在住で、オンライン内見からご契約まで全て周周にリモートでサポートしていただきました。とても安心でき、引き渡し後の細かい手続きまでしっかり対応していただきました。", who: "アメリカ K様ご夫妻（リモート内見）", reply: "海を越えてのご信頼、ありがとうございます❤️ リモートは何より「安心できるか」が大切。米国からでも安心してお引渡しを迎えていただけたことが私の一番の願いでした。またいつでもどうぞ😆" },
  { text: "購入後も、周周に電気・ガス・水道の手続きや管理会社とのやり取り、鍵の交換まで対応していただきました。アフターサービスが本当に素晴らしく、心から感謝しています。", who: "日本在住 T様（自宅購入・アフターサポート）", reply: "とても嬉しいお言葉です😆 購入はスタートで、入居後の細々したことまでお手伝いできることこそ大切だと思っています❤️ 今後も遠慮なくご連絡ください〜" },
  { text: "初めて日本で一戸建てを購入しました。土地探しから内見、ご契約まで、周周が丁寧に説明してくださったおかげで、台湾にいながら安心して決断できました。", who: "台湾 J様ご夫妻（初めての一戸建て購入）", reply: "初めての戸建ては確認事項も多く、信じてくださり感謝です🫶🏻 台湾にいながら安心してご決断いただけたこと、本当に嬉しく思います。新居での毎日が順調でありますように🏡✨" },
  { text: "千葉で土地を購入する際は確認事項が多かったのですが、周周が用途地域や権利関係、現況までしっかり確認してくれました。プロセスが透明で丁寧、とても専門的でした。", who: "台湾 H様（千葉の土地購入）", reply: "土地は確認することが特に多く、ご信頼ありがとうございます❤️ 用途地域・権利関係・現況までしっかり確認し、安心してご購入いただくのが私の仕事です。またいつでもどうぞ☺️" },
  { text: "還暦を迎えてから、思い立って日本への移住を実現しました。異国の地で新しいことを学び、自分自身を大切にしながら、心身ともに自由を取り戻すことができました。周周には最初から最後までサポートしていただき、すべて順調に進みました。", who: "日本へ移住されたC様（退職後の移住）", reply: "人生の大切な一歩に関わらせていただき光栄です🥹 日本での新しい暮らしが健やかで自由なものでありますように❤️ 生活で何かあればいつでもご連絡ください〜" }
];
...
const JA_UI = {
  ...
  reviewsNote: "💛 お客様からよくいただくお声：中国語でのフルサポート、電気・ガス・水道や携帯電話、管理会社、土地購入・新築のご相談まで対応するアフターサービス、遠方でも自ら足を運ぶ姿勢。<br><br>物件購入はゴールではなく、安心して暮らせることが本当に大切なポイントです。",
...
@media(max-width:600px){.smbox{padding:20px 18px 16px}.smhd h3{font-size:16px}}
  ...
  <div class="hbtns"><a class="b-line" href="https://lin.ee/RscRWCp" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16v11H10l-4 4v-4H4z"/><path d="M8.5 10.5h.01M12 10.5h.01M15.5 10.5h.01"/></svg>無料LINE相談</a><a class="b-case" onclick="var r=document.querySelector('.reviews');if(r)r.scrollIntoView({behavior:'smooth'});return false"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M10 8l6 4-6 4z" fill="currentColor" stroke="none"/></svg>お客様のリアルな声</a></div>
    ...
    <div class="trustbar">
      <div class="tb"><span class="ti"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 2.6v5.4c0 4.2-2.9 7.2-7 8.5-4.1-1.3-7-4.3-7-8.5V5.6z"/><rect x="9.6" y="8.6" width="4.8" height="6.9" rx="0.4"/><path d="M11 11h.01M13 11h.01M11 13.2h.01M13 13.2h.01"/></svg></span><div><b>日本の正規不動産会社</b><span>安心のお取引</span></div></div>
      <div class="tb"><span class="ti"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16v11H10l-4 4v-4H4z"/><path d="M8.5 10.5h.01M12 10.5h.01M15.5 10.5h.01"/></svg></span><div><b>中国語フルサポート</b><span>言葉の心配なし</span></div></div>
      <div class="tb"><span class="ti"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="3.2"/><path d="M5.5 20c0-3.4 2.9-5.8 6.5-5.8s6.5 2.4 6.5 5.8"/></svg></span><div><b>500名以上をサポート</b><span>豊富な成約実績</span></div></div>
      <div class="tb"><span class="ti"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s7-6.3 7-11.5A7 7 0 1 0 5 9.5C5 14.7 12 21 12 21z"/><circle cx="12" cy="9" r="2.5"/></svg></span><div><b>東京23区に精通</b><span>神奈川・千葉も対応</span></div></div>
    </div>
    <div class="flowsec">
    ...
    <div id="svcWrap">
    <div class="hlp">
      <div class="hlp-head"><span class="hlp-sp"></span><h2>私がお手伝いできること</h2><a class="hlp-more" onclick="show('services');return false" href="javascript:void(0)">もっと見る →</a></div>
      <div class="hlp-grid"><a class="hlp-card" onclick="show('live');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.7V21h14V9.7"/><path d="M9.5 21v-6h5v6"/></svg></span><b>自宅購入</b><p>理想の住まい探しから引き渡しまで</p></a><a class="hlp-card" onclick="show('invest');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 7h1.5M13.5 7h1.5M9 11h1.5M13.5 11h1.5M9 15h1.5M13.5 15h1.5"/><path d="M10.5 21v-3h3v3"/></svg></span><b>投資物件</b><p>高利回り物件の厳選・分析</p></a><a class="hlp-card" onclick="show('services');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="2"/><rect x="8" y="6" width="8" height="3" rx="0.5"/><path d="M8.5 13h.01M12 13h.01M15.5 13h.01M8.5 17h.01M12 17h.01M15.5 17h.01"/></svg></span><b>ローン相談</b><p>銀行審査・ローン設計をサポート</p></a><a class="hlp-card" onclick="show('services');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v4h4"/><path d="M10 12h5M10 16h5"/></svg></span><b>書類翻訳</b><p>契約書・書類の代行と翻訳</p></a><a class="hlp-card" onclick="show('process');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10.5 10 5l7 5.5"/><path d="M5 9.7V19h5.5"/><circle cx="16.5" cy="15.5" r="3.3"/><path d="M19 18l2.2 2.2"/></svg></span><b>内見・引き渡し</b><p>細部チェック・全工程サポート</p></a><a class="hlp-card" onclick="show('services');return false" href="javascript:void(0)"><span class="si"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="6.5" r="2.6"/><path d="M2 20l6-7.5 4 5 3.5-4.5 6.5 7z"/></svg></span><b>日本生活相談</b><p>生活・就労情報で安心の暮らし</p></a></div>
    </div>
    </div>
    <div class="intro">
      ...
      <div class="homevid" style="width:180px;flex-shrink:0;aspect-ratio:9/16;border-radius:14px;overflow:hidden;box-shadow:0 6px 20px rgba(0,0,0,.15);background:#000">
        <div class="ytf" data-id="YwqJo7iZuQI"><img src="https://i.ytimg.com/vi/YwqJo7iZuQI/maxresdefault.jpg" onerror="this.onerror=null;this.src='https://i.ytimg.com/vi/YwqJo7iZuQI/hqdefault.jpg'" alt="${JA_UI.altVideo}" loading="lazy" width="1280" height="720"><span class="pbtn">▶</span></div>
      </div>
      </div>
    </div>
...
<footer>
  ...
  <div class="wrap" style="padding:0 16px 10px;display:flex;flex-wrap:wrap;gap:14px;font-size:13px"><a href="buy-property-in-japan-ja.html" style="color:var(--mut)">記事一覧</a><a href="properties-ja.html" style="color:var(--mut)">物件情報</a><a href="japan-real-estate-agent-for-taiwanese-ja.html" style="color:var(--mut)">中華圏のお客様の購入窓口</a><a href="sell-your-property-ja.html" style="color:var(--mut)">売却をお考えの方へ</a><a href="tokyo-area-guide-ja.html" style="color:var(--mut)">エリア相場</a><a href="feedback-ja.html" style="color:var(--mut)">${JA_UI.footerNav.feedback}</a><a href="tool-loan-ja.html" style="color:var(--mut)">${JA_UI.footerNav.tools}</a><a href="videos-ja.html" style="color:var(--mut)">${JA_UI.footerNav.videos}</a><a href="translate-ja.html" style="color:var(--mut)">${JA_UI.footerNav.translate}</a><a href="about-ja.html" style="color:var(--mut)">周欣妤について</a><a href="privacy-ja.html" style="color:var(--mut)">プライバシーポリシー</a>
...
const TOOLDD='<div class="navdd"><button class="navdd-b">${JA_UI.navddTool}</button><div class="navdd-m"><a href="translate-ja.html">${JA_UI.nav.translate}</a>'+${JSON.stringify(JA_UI.tools)}.map(function(t){return '<a href="'+t[1]+'">'+t[0]+'</a>';}).join("")+'</div></div>';
...
const ABOUTDD=\`<div class="navdd"><button class="navdd-b">会社案内 ▾</button><div class="navdd-m"><a onclick="show('videos');return false">${JA_UI.nav.videos}</a><a data-v="about" onclick="show('about');return false">${JA_UI.nav.about}</a></div></div>\`;
document.getElementById('mainnav').innerHTML=[\`<a data-v="home" onclick="show('home');return false">${JA_UI.nav.home}</a>\`,\`<a href="properties-ja.html">物件情報</a>\`,\`<a href="tokyo-area-guide-ja.html">エリア相場</a>\`,SVCDD,TOOLDD,\`<a data-v="faq" onclick="show('faq');return false">${JA_UI.nav.faq}</a>\`,\`<a onclick="show('feedback');return false">${JA_UI.nav.feedback}</a>\`,ABOUTDD].join('<span class="nsep">｜</span>');
function mi(p){return '<span class="mi"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">'+p+'</svg></span>';}
const MIC={home:'<path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.7V21h14V9.7"/><path d="M9.5 21v-6h5v6"/>',bldg:'<rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 7h1.5M13.5 7h1.5M9 11h1.5M13.5 11h1.5M9 15h1.5M13.5 15h1.5"/><path d="M10.5 21v-3h3v3"/>',pin:'<path d="M12 21s7-6.3 7-11.5A7 7 0 1 0 5 9.5C5 14.7 12 21 12 21z"/><circle cx="12" cy="9" r="2.5"/>',svc:'<rect x="6" y="4" width="12" height="17" rx="2"/><path d="M9 4V3h6v1"/><path d="M9 10h6M9 14h6M9 18h3"/>',tool:'<rect x="5" y="3" width="14" height="18" rx="2"/><rect x="8" y="6" width="8" height="3" rx="0.5"/><path d="M8.5 13h.01M12 13h.01M15.5 13h.01M8.5 17h.01M12 17h.01M15.5 17h.01"/>',faq:'<circle cx="12" cy="12" r="9"/><path d="M9.6 9.4a2.5 2.5 0 1 1 3.6 2.2c-.8.4-1.2 1-1.2 1.9"/><path d="M12 17h.01"/>',user:'<circle cx="12" cy="8" r="3.4"/><path d="M5 20c0-3.6 3.1-5.6 7-5.6s7 2 7 5.6"/>',chat:'<path d="M4 5h16v11H10l-4 4v-4H4z"/><path d="M8.5 10.5h.01M12 10.5h.01M15.5 10.5h.01"/>'};
function mgrp(icon,label,items){return '<div class="mgroup"><button class="mg-h" type="button" onclick="this.parentNode.classList.toggle(\\'open\\')"><span class="mg-l">'+mi(icon)+label+'</span><span class="mg-a">▾</span></button><div class="mg-b">'+items+'</div></div>';}
document.getElementById('mnav').innerHTML=\`<a onclick="show('home');return false">\${mi(MIC.home)}${JA_UI.nav.home}</a><a href="properties-ja.html">\${mi(MIC.bldg)}物件情報</a><a href="tokyo-area-guide-ja.html">\${mi(MIC.pin)}エリア相場</a>\`+mgrp(MIC.svc,'${JA_UI.mobileLabels.services}',\`<a onclick="show('services');return false">${JA_UI.nav.services}</a><a onclick="show('process');return false">${JA_UI.nav.process}</a><a onclick="show('live');return false">${JA_UI.nav.live}</a><a onclick="show('invest');return false">${JA_UI.nav.invest}</a>\`)+mgrp(MIC.tool,'${JA_UI.mobileLabels.tools}',[["${JA_UI.nav.translate}","translate-ja.html"],["住宅ローン試算","tool-loan-ja.html"],["購入費用","tool-cost-ja.html"],["仲介手数料","tool-agent-ja.html"],["利回り試算","tool-yield-ja.html"],["為替レート","tool-fx-ja.html"],["坪・畳換算","tool-area-ja.html"]].map(function(t){return '<a href="'+t[1]+'">'+t[0]+'</a>';}).join(""))+\`<a onclick="show('faq');return false">\${mi(MIC.faq)}${JA_UI.nav.faq}</a>\`+mgrp(MIC.user,'会社案内',\`<a onclick="show('videos');return false">${JA_UI.nav.videos}</a><a onclick="show('about');return false">${JA_UI.nav.about}</a>\`)+\`<a href="feedback-ja.html">\${mi(MIC.chat)}${JA_UI.nav.feedback}</a><a class="m-line" href="\${S.line}" target="_blank" rel='noopener'>\${mi(MIC.chat)}${JA_UI.lineBtn}</a>\`;
...
<!--comments--><script type="module" src="comments.js"></script>
