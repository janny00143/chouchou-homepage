...
const REVIEWS_JA = [
  { text: "物件のご提案からオンライン内見・オンライン立会いまで、周さんに親身に対応いただきました。現地に行けない私たちのために家の細部まで丁寧に確認してくださり、引渡し後も全く違いがありませんでした。日本語が堪能で意思疎通もスムーズ、終始丁寧で誠実。引渡し後も煩雑な手続きを数多く手伝ってくださいました。本当に得難い方で、心から感謝しています。", who: "オンラインで内見・購入されたお客様", reply: "🎊 こんなに長いお言葉を書いてくださり、本当にありがとうございます🥹❤️ 物件探しから内見・立会い、ご引渡しまでご一緒できたことは、私にとっても大切な思い出です。現地にいらっしゃれない分、一回一回の内見・確認で代わりにもう一つでも多く確かめ、お受け取りの瞬間に安心していただけたら——その一心でした😆 大切な人生の節目をお任せいただき心から感謝しています🫶🏻 今後もお住まいや日本での生活で何かあればいつでもご連絡ください。新しいお住まいでの幸せな毎日を心よりお祈りしています🏡✨" },
