...
<main class="wrap">
  <section class="view on" id="v-home">
    <style>.herob .chips{gap:8px;flex-wrap:wrap}.herob .chip{font-size:13px;padding:7px 12px;gap:6px;white-space:nowrap}.herob .chip svg{width:15px;height:15px}@media(min-width:601px){.herob .chips{flex-wrap:nowrap}}</style>
...
<footer>
  ...
  <div class="wrap" style="padding:0 16px 10px;display:flex;flex-wrap:wrap;gap:14px;font-size:13px"><a href="properties-ja.html" style="color:var(--mut)">🏠 物件情報</a><a href="tokyo-area-guide-ja.html" style="color:var(--mut)">🗺️ エリア相場</a><a href="feedback-ja.html" style="color:var(--mut)">${JA_UI.footerNav.feedback}</a><a href="tool-loan-ja.html" style="color:var(--mut)">${JA_UI.footerNav.tools}</a><a href="videos-ja.html" style="color:var(--mut)">${JA_UI.footerNav.videos}</a><a href="translate-ja.html" style="color:var(--mut)">${JA_UI.footerNav.translate}</a>
...
document.getElementById('mainnav').innerHTML=\`<a data-v="home" onclick="show('home');return false">${JA_UI.nav.home}</a><a href="properties-ja.html">物件情報</a><a href="tokyo-area-guide-ja.html">エリア相場</a>\${SVCDD}\${TOOLDD}<a onclick="show('translate');return false">${JA_UI.nav.translate}</a><a onclick="show('videos');return false">${JA_UI.nav.videos}</a><a data-v="faq" onclick="show('faq');return false">${JA_UI.nav.faq}</a><a data-v="about" onclick="show('about');return false">${JA_UI.nav.about}</a><a onclick="show('feedback');return false">${JA_UI.nav.feedback}</a>\`;
document.getElementById('mnav').innerHTML=\`<a onclick="show('home');return false">🏠 ${JA_UI.nav.home}</a><a href="properties-ja.html">🏢 物件情報</a><a href="tokyo-area-guide-ja.html">🗺️ エリア相場</a><div class="mgroup"><button class="mg-h" type="button" onclick="this.parentNode.classList.toggle('open')">🤝 ${JA_UI.mobileLabels.services} <span class="mg-a">▾</span></button><div class="mg-b"><a onclick="show('services');return false">　${JA_UI.nav.services}</a><a onclick="show('process');return false">　${JA_UI.nav.process}</a><a onclick="show('live');return false">　${JA_UI.nav.live}</a><a onclick="show('invest');return false">　${JA_UI.nav.invest}</a></div></div><div class="mgroup"><button class="mg-h" type="button" onclick="this.parentNode.classList.toggle('open')">🧰 ${JA_UI.mobileLabels.tools} <span class="mg-a">▾</span></button><div class="mg-b">\`+[["🏦 住宅ローン試算","tool-loan-ja.html"],["💴 購入費用","tool-cost-ja.html"],["🤝 仲介手数料","tool-agent-ja.html"],["📈 利回り試算","tool-yield-ja.html"],["💱 為替レート","tool-fx-ja.html"],["📐 坪・畳換算","tool-area-ja.html"]].map(function(t){return '<a href="'+t[1]+'">　'+t[0]+'</a>';}).join("")+\`</div></div><a onclick="show('translate');return false">🈯 ${JA_UI.nav.translate}</a><a onclick="show('videos');return false">🎬 ${JA_UI.nav.videos}</a><a onclick="show('faq');return false">❓ ${JA_UI.nav.faq}</a><a onclick="show('about');return false">👩 ${JA_UI.nav.about}</a><a href="feedback-ja.html">💬 ${JA_UI.nav.feedback}</a><a href="\${S.line}" target="_blank" style="color:var(--green-d);font-weight:700" rel='noopener'>💚 ${JA_UI.lineBtn}</a>\`;
