...
const REVIEWS_JA = [
  { text: "物件のご提案からオンライン内見・オンライン立会いまで、周さんに親身に対応いただきました。現地に行けない私たちのために家の細部まで丁寧に確認してくださり、引渡し後も全く違いがありませんでした。日本語が堪能で意思疎通もスムーズ、終始丁寧で誠実。引渡し後も煩雑な手続きを数多く手伝ってくださいました。本当に得難い方で、心から感謝しています。", who: "オンラインで内見・購入されたお客様" },
