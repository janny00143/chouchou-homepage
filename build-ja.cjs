...
${a.coverFit === "contain" ? `<img src="${cover}" alt="${esc(j.title)}" loading="lazy" style="width:100%;border-radius:18px;display:block;margin-bottom:20px">` : `<div class="acov" style="${bg}"><span>${catName}</span></div>`}
