...
${a.coverFit === "contain" ? `<img src="${cover}" alt="${esc(j.title)}" loading="lazy" style="width:100%;height:auto;border-radius:18px;display:block;margin:0 auto 20px">` : `<div class="acov" style="${bg}"><span>${catName}</span></div>`}
