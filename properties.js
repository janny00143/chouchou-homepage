...
/* ── 物件維護規則（周周指示）──────────────────────────────
   ...
   ⭐ 置頂：pin 欄位（數字越大排越前面，只影響「預設」排序）
      ・2026-08-23 周周指示把「東京鐵塔」的兩件放最上面：
        ...
        ※ 這兩件後來都已下架（shiba2802 於 2026-08-28、toranomon403 於 2026-09-06），
          目前沒有東京鐵塔景的置頂物件。之後若有同類物件要置頂，設 pin 即可。
...
window.PROPERTIES = [
  {
    ...
    right: "所有權",
    yield: "",
    photos: ["prop-kototoi902-1.webp","prop-kototoi902-plan.webp","prop-kototoi902-2.webp","prop-kototoi902-3.webp","prop-kototoi902-4.webp","prop-kototoi902-5.webp","prop-kototoi902-6.webp","prop-kototoi902-7.webp","prop-kototoi902-8.webp","prop-kototoi902-9.webp","prop-kototoi902-10.webp","prop-kototoi902-11.webp"],
    note: "■ 這間的主角是陽台\n站在陽台就看得到晴空塔，而且是9樓南東角戶，前面沒有東西擋住。這種「打開窗就是晴空塔」的房子，在墨田區不是隨時都有——同一棟裡也只有這個方位這個樓層做得到。（眺望會隨天候變化，也無法保證未來周邊建物不變，這點我先講清楚。）\n■ 位置\n東京晴空塔站徒步7分、本所吾妻橋站徒步8分、押上站徒步11分，三站三條線。東京ソラマチ約510m、東京ミズマチ約350m，吃飯買東西散步都在腳程內；隅田公園只要約70m，早上去河邊走一圈很舒服。淺草過一座橋就到。\n■ 格局\n1LDK，LDK約12.8帖＋洋室約5.0帖，專有46.45㎡。一個人住很寬裕，兩個人住也不擁擠。洗面室、浴室、廁所三分離，還有步入式衣帽間（WIC）與玄關收納，收納配置在這個坪數算很有誠意。\n■ 屋況\n2026年7月2日剛完成全面翻新——地板、壁紙、廚房、洗面台、廁所、整體衛浴、建具全部換新，還裝了一台新空調。附食洗機、浴室乾燥機、追焚機能，照明與家具也附上，行李搬進去就能住。賣方另附售後服務保證。\n■ 建築本身\n1982年7月築、SRC・RC造10層建，總戶數35戶，管理是全部委託＋日勤管理員，2022年9月已經做過大規模修繕。屋齡較長的物件在房貸年限與成數上，各家銀行的看法會不一樣，這部分我可以先幫你問幾家再決定怎麼出手。\n■ 要先知道的三件事\n一、這棟不可養寵物。二、敷地內沒有停車場，有車的要另外找月租車位。三、每月管理費＋修繕積立金合計26,480円，請先算進預算。\n現況空屋，隨時可以看房。想約看、或想先問問外國人在日本買房要準備什麼文件、貸款怎麼談，加LINE跟周周說一聲，我用中文一步一步陪你走完（實際條件以現況與重要事項說明書為準；能不能貸、可貸成數依個案與銀行審查為準；稅額請由稅理士確認；登記與契約由司法書士・宅建士確認）。"
  },
