...
window.PROPERTIES = [
...

  {
    ...
    status: "在售",
    cat: "invest",
    title: "R西九条 柚（此花區西九條4丁目）",
    title_cn: "大阪市此花區 西九條站2分 民宿一棟（改裝中・2027年2月預計營運）",
    price: "9,100万円",
    location: "大阪府大阪市此花區西九條四丁目",
    station: "JR大阪環狀線・阪神難波線「西九條」站 徒步2分",
    layout: "民宿一棟（地上3層＋屋頂平台・1樓LDK與寢室／2・3樓寢室共5間）",
    size: "土地面積56.33㎡（約17.04坪）・建物面積136.62㎡（約41.33坪／1F 45.54㎡＋2F 45.54㎡＋3F 45.54㎡）",
    age: "1981年3月築・<b>改裝中</b>（賣方資料：2027年1月上旬預計全面改裝完成、1月下旬搬入設備備品、2月預計開始營運）",
    facing: "鐵骨造平屋頂3層樓建築・私道負擔無・退縮距離無・第二種住居地域／準防火地域・建蔽率80%／容積率300%・市街化區域",
    mgmt: "附帶照明・空調・家具・家電，運營公司可變更及繼承",
    right: "所有權",
