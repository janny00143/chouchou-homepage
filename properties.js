...
window.PROPERTIES = [
...

  {
    ...
    cat: "invest",
    title: "中目黒借地1棟店舗",
    title_cn: "【獨家】中目黑5分 目黑銀座商店街 整棟店舖（借地權）",
    price: "1億9,300万円（含稅）",
    location: "東京都目黑區上目黑2丁目",
    station: "東急東橫線「中目黑」站 徒步5分",
    layout: "整棟2層店舖（1樓33.88㎡・2樓23.14㎡）・連棟式",
    size: "對象土地43.61㎡（約13.19坪・借地）／延床57.02㎡（約17.24坪）",
    age: "築年月不詳（木造瓦葺2層・連棟式・舊耐震）",
    facing: "商業地域・防火地域（建蔽率80%／容積率400%・路線價679,000円/㎡）",
