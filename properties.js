...
/* ── 物件維護規則（周周指示）──────────────────────────────
   ...
   ⛔ 借地權物件一律不上架（周周 2026-08-23 指示）：
      ...
      **不要自己判斷要不要上，先提醒周周**。
      ...
      ・⚠️ 尚待周周決定：toranomon403（虎之門 望東京鐵塔）也是借地權
        （旧法賃借権・～2036年7月），已回報，未經指示不要自行撤下。

   ⭐ 置頂：pin 欄位（數字越大排越前面，只影響「預設」排序）
      ・2026-08-23 周周指示把「東京鐵塔」的兩件放最上面：
        shiba2802（pin:20・足下東京鐵塔）／shinbashi807（pin:19・眺望東京鐵塔）
        原本要放的 toranomon403 因為是借地權，先不置頂。
