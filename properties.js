...
window.PROPERTIES = [
...

  {
    ...
    right: "所有權",
    yield: "",
    photos: ["prop-kanamachi3612-1.webp","prop-kanamachi3612-plan.webp","prop-kanamachi3612-2.webp","prop-kanamachi3612-3.webp","prop-kanamachi3612-4.webp","prop-kanamachi3612-5.webp","prop-kanamachi3612-6.webp","prop-kanamachi3612-7.webp","prop-kanamachi3612-8.webp","prop-kanamachi3612-9.webp"],
    note: "■ 這間是什麼\n金町站大規模重劃區裡的37層塔樓，這戶在36樓、西向角戶，4SLDK・專有77.83㎡。2016年2月築、竹中工務店施工，總戶數700戶。\n■ 亮點\n相簿裡的眺望照都是從這戶實際拍的——白天看得到江戶川與一整片開闊的天空，晚上是整面的市區燈火。36樓的角戶在這一帶幾乎不會釋出（眺望會隨天候變化，也無法保證未來周邊建物不變）。\n■ 格局與規格\n四房＋多功能房，77.83㎡在這個總價帶算很能住；LDK約11.0帖，主臥附步入式衣帽間，玄關還有自己的前庭。衛浴三分離，廚房附三口爐、洗碗機、廚餘處理機；浴室有追焚、浴室乾燥與霧氣三溫暖。大樓是免震構造，24小時有人管理＋禮賓服務、各樓層24小時可丟垃圾，另有訪客房與兒童遊戲室，可養寵物（細則有）。管理費＋修繕積立金合計32,435円／月。\n■ 這是業界未公開物件\n沒有掛在任何網站或同業平台，只有我這邊可以介紹。現況居住中，看房要先跟屋主約時間，想看的話早點跟我說。加LINE跟我說一聲，我用中文一步一步陪你走完（設備之契約不適合責任免責；實際條件以現況與重要事項說明書為準；能不能貸、可貸成數依個案與銀行審查為準；稅額請由稅理士確認；登記與契約由司法書士・宅建士確認）。"
  },
