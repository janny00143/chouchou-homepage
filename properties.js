...
window.PROPERTIES = [
  ...
  /* ===== 以下為實需（自住）中古翻新公寓，來自同一份型錄 ===== */
  {
    id: "shinden108", status: "在售", cat: "live",
    title: "アクアテラ ブロード・スクエア 108（足立新田 4LDK・114㎡大坪數・附專用庭）",
    price: "9,980万円",
    location: "東京都足立區新田3-37-12",
    station: "「哈特島南」巴士站 徒步1分（往王子站巴士約15分）／東京Metro南北線「王子神谷」站 徒步19分",
    layout: "4LDK",
    size: "114.49㎡（約34.63坪）",
    age: "築18年（2008年1月）",
    facing: "", mgmt: "管理費14,275円＋修繕積立金15,399円／月", right: "所有權",
    yield: "",
    photos: [],
    note: "少見的4LDK大坪數（114㎡），附32㎡專用庭與露台，社區共用設施豐富（兒童室、客房、劇院室、管家服務），可養寵物（共2隻），全新翻修。很適合想要大空間的家庭。交通以巴士為主。想看房加LINE我幫你安排。"
  },
  {
    id: "kaiei801", status: "在售", cat: "live",
    title: "グランドメゾン開栄 801（大久保 3LDK・82㎡・全新翻修）",
    price: "1億680万円",
    location: "東京都新宿區大久保2-2-22",
    station: "東京Metro副都心線「東新宿」站 徒步4分／「西早稻田」站 徒步6分",
    layout: "3LDK",
    size: "82.12㎡（約24.84坪）",
    age: "築43年（1983年6月）",
    facing: "", mgmt: "管理費16,670円＋修繕積立金8,210円／月", right: "所有權",
    yield: "",
    photos: [],
    note: "82㎡寬敞3LDK、東新宿站徒步4分，全新翻修（廚房、衛浴、地板、壁紙等），可養寵物、新耐震標準。適合想在新宿一帶自住的家庭。想看房或試算貸款加LINE（可貸成數依銀行審查為準）。"
  },
  {
    id: "hakusan802", status: "在售", cat: "live",
    title: "シルバープラザ白山 802（文京白山 1DK・8樓角戶・全新翻修）",
    price: "5,180万円",
    location: "東京都文京區白山1-6-5",
    station: "都營三田線「白山」站 徒步7分／「春日」站 徒步7分／「後樂園」站 徒步10分",
    layout: "1DK",
    size: "38.23㎡（約11.56坪）",
    age: "築41年（1985年8月）",
    facing: "8樓・角住戶",
    mgmt: "管理費11,510円＋修繕積立金10,590円／月", right: "所有權",
    yield: "",
    photos: [],
    note: "白山站徒步7分、8樓角戶，10分內3站4線、生活機能好，全新翻修。登記為住宅、也可作簡易事務所使用（有細則）。適合單身自住或小資置產。想看房加LINE我幫你把關。"
  },
  {
    id: "mejiro703", status: "在售", cat: "live",
    title: "ライオンズマンション目白 703（目白 2LDK・7樓南西向・全新翻修）",
    price: "8,780万円",
    location: "東京都豐島區目白2-5-20",
    station: "東京Metro副都心線「雜司谷」站 徒步4分／JR山手線「目白」站 徒步9分／「池袋」站 徒步9分",
    layout: "2LDK",
    size: "53.55㎡（約16.20坪）",
    age: "築26年（2000年1月）",
    facing: "7樓・南西向",
    mgmt: "管理費13,920円＋修繕積立金19,810円／月", right: "所有權",
    yield: "",
    photos: [],
    note: "雜司谷、目白、池袋3站可用，7樓南西向、採光與視野好，全新翻修，2025~2026年剛做完大規模修繕，可養寵物。適合想住目白一帶的你。（修繕積立金2026年8月起將調整）想看房加LINE。"
  },
  {
    id: "kaigan1901", status: "在售", cat: "live",
    title: "エクサージュ海岸 1901（芝浦 2LDK・19樓角戶・視野佳）",
    price: "1億3,600万円",
    location: "東京都港區海岸3-12-3",
    station: "百合海鷗線「芝浦碼頭」站 徒步4分／JR・都營「田町」站 徒步14分",
    layout: "2LDK",
    size: "67.79㎡（約20.5坪・含儲藏室）",
    age: "築24年（2002年3月）",
    facing: "19樓・角住戶",
    mgmt: "管理費12,050円＋修繕積立金10,310円／月", right: "所有權",
    yield: "",
    photos: [],
    note: "19樓角戶、67㎡ 2LDK，附玄關旁儲藏室，採光與眺望好，飯店式內廊下、可養寵物，翻修工程進行中。適合想要高樓層視野的自住買家。想看房或了解交屋時程加LINE。"
  }
