...
window.PROPERTIES = [
...

  {
    ...
    cat: "house",
    title: "深沢3丁目 新築戸建",
    title_cn: "深沢 世田谷高級住宅區 新築3層戸建（自社）",
    price: "1億4,480万円",
...

  {
    ...
    cat: "house",
    title: "世田谷區 未公開新築一戶建",
    title_cn: "世田谷 未公開新築一戶建（獨家）",
    price: "個別洽詢（非公開）",
    location: "東京都世田谷區",
    station: "世田谷區內・生活與教育環境完整（詳細交通個別提供）",
    layout: "3LDK+S",
    size: "建物約110㎡以上・土地約70㎡以上（約20帖LDK）",
    age: "新築（新成屋）",
    facing: "南側道路・採光佳",
    mgmt: "一戶建・無管理費與修繕積立金",
    right: "所有權（土地＋建物）",
    ...
    note: "世田谷區住宅環境良好的區域，周周近期取得一間「尚未公開」的新築一戶建——目前僅限個別介紹，所以網站上不公開詳細地址、售價與格局圖。物件特色：世田谷安靜住宅區、木造3層樓、約20帖寬敞LDK、3LDK＋多功能空間（S）、附車庫與步入式衣帽間、南側道路採光佳，小學、公園與便利商店、超市都在步行範圍內。因為屬於未公開資訊、也不對外流通給其他仲介，完整地址、售價與格局會在確認購屋需求後個別提供。有興趣的話，加LINE告訴周周「世田谷未公開一戶建＋你的預算與購屋用途」，我再為你個別介紹（此為示意圖非實際物件；能不能貸、可貸成數依個案與銀行審查為準）。"
  },
